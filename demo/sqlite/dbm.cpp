...
inline DBM::DBM(QSqlDatabase* __db, QObject* parent) : QObject(parent), db(__db)
{
...
bool DBM::addFrame(QString & time,QString & channel,QString & frame_id,QString & period,QString & frame_count,QString & direction,QByteArray& data)
{
    QSqlQuery query(*db);
